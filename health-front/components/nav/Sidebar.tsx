...
const navItems: NavItem[] = [
  ...
  {
    href: "/dashboard/in-house",
    label: "In-House",
    icon: <Home className="h-4 w-4" aria-hidden />,
    requiresAnyPermissions: ["inhouse:list", "inhouse:read"],
    children: [
      {
        href: "/dashboard/in-house/admissions",
        label: "Admissions",
        icon: <CalendarCheck2 className="h-4 w-4" aria-hidden />,
        requiresAnyPermissions: ["inhouse:list", "inhouse:read"],
      },
      {
        href: "/dashboard/in-house/doctor",
        label: "Doctor",
        icon: <UserCircle className="h-4 w-4" aria-hidden />,
        requiresAnyPermissions: ["inhouse:pick", "inhouse:clinical"],
      },
      {
        href: "/dashboard/in-house/in-care",
        label: "In care",
        icon: <Stethoscope className="h-4 w-4" aria-hidden />,
        requiresAnyPermissions: ["inhouse:list", "inhouse:read"],
      },
      {
        href: "/dashboard/in-house/discharged",
        label: "Discharged",
        icon: <ListOrdered className="h-4 w-4" aria-hidden />,
        requiresAnyPermissions: ["inhouse:list", "inhouse:read"],
      },
